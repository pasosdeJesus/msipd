...
--
-- Name: msip_centropoblado_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.msip_centropoblado_id_seq OWNED BY public.msip_centropoblado.id;
...
CREATE VIEW public.msip_divipola AS
 SELECT msip_departamento.deplocal_cod AS coddep,
    ...
    msip_centropoblado.id AS sip_idcp
...
--
-- Name: msip_centropoblado id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.msip_centropoblado ALTER COLUMN id SET DEFAULT nextval('public.msip_centropoblado_id_seq'::regclass);
...
--
-- Name: msip_tcentropoblado sip_tclase_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
